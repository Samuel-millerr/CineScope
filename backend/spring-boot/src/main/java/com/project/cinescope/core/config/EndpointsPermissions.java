...
public enum EndpointsPermissions {
    ...
    AUTH_HEALTH(HttpMethod.GET, ApiEndpoints.Auth.HEALTH, Access.ADMIN),
    ...
    ACTORS_HEALTH(HttpMethod.GET, ApiEndpoints.Actors.HEALTH, Access.ADMIN),
    ...
    DIRECTORS_HEALTH(HttpMethod.GET, ApiEndpoints.Directors.HEALTH, Access.ADMIN),
    ...
    GENRES_HEALTH(HttpMethod.GET, ApiEndpoints.Genres.HEALTH, Access.ADMIN),
    ...
    MOVIES_HEALTH(HttpMethod.GET, ApiEndpoints.Movies.HEALTH, Access.ADMIN),
    ...
    REQUESTS_HEALTH(HttpMethod.GET, ApiEndpoints.Requests.HEALTH, Access.ADMIN),
    ...
    REVIEWS_HEALTH(HttpMethod.GET, ApiEndpoints.Reviews.HEALTH, Access.ADMIN),
    ...
    USERS_HEALTH(HttpMethod.GET, ApiEndpoints.Users.HEALTH, Access.ADMIN);
